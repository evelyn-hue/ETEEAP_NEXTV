  ...
  return (
    <main className="min-h-screen bg-linear-to-b from-blue-50 to-white mt-12">
      <section className="relative w-full h-75 flex items-center justify-center overflow-hidden">
        <Image
          src={imgSrc.mm}
          alt="Bachelor of Science in Business Administration - Marketing Management"
          fill
          priority
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <div className="mb-16">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border-l-4 border-blue-600">
            <p className="text-gray-700 text-lg leading-relaxed">
              Bachelor of Science in Business Administration - Marketing Management develops strong
        ...
        <div className="bg-linear-to-r from-blue-600 to-blue-800 rounded-xl shadow-xl p-12 text-center text-white mb-16">
          ...
          <ApplyButton
            ...
            programName="Bachelor of Science in Business Administration - Marketing Management"
          />
        </div>
