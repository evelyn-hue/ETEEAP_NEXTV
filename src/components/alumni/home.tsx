...
export default function AlumniFeedPage() {
  ...
  return (
    <main className="min-h-screen p-6 mt-18">
      <div className="max-w-5xl mx-auto bg-white rounded-xl shadow-sm ring-1 ring-slate-200/30 p-6 mb-6">
        <SectionHeading className="mb-6">Alumni Feed</SectionHeading>
      ...
      <Reveal>
      <div className="max-w-5xl mx-auto mb-6 bg-white rounded-xl shadow-sm ring-1 ring-slate-200/30 p-6">
        <div className="grid grid-cols-1 gap-3 lg:grid-cols-[minmax(0,1fr)_minmax(180px,240px)_minmax(160px,200px)]">
          <input
            className="w-full border border-gray-300 rounded-lg px-4 py-2 bg-white text-gray-800 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-600/30"
          ...
          <select
            className="w-full border border-gray-300 rounded-lg px-4 py-2 bg-white text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-600/30"
      ...
      {loading ? (
        ...
        <StaggerContainer className="max-w-5xl mx-auto space-y-6">
          ...
          {filteredAlumni.map((person) => (
            <StaggerItem key={person.id} className="bg-white rounded-xl shadow-sm ring-1 ring-slate-200/30 p-6 hover:shadow-lg transition">
